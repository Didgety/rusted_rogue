...
impl State {
    fn run_systems(&mut self) {
        ...
        // check triggers after movement and before anything else
    ...
    fn entities_to_remove_on_level_change(&mut self) -> Vec<Entity> {
        ...
        for entity in entities.join() {
            ...
            // Do not equip monsters with items using this implementation or they will never be deleted
    ...
    fn goto_next_level(&mut self) {
        ...
        for target in to_delete {
            self.ecs.delete_entity(target).expect("Unable to delete entity: {target}");
        }
