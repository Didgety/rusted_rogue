...
impl DLABuilder {
    // TODO document options and what they do when creating a DSA map with custom parameters
    pub fn new(new_depth : i32, b_size : i32, alg : DLAAlgorithm, sym : DLASymmetry, f_pct : f32) -> DLABuilder {
        DLABuilder{
