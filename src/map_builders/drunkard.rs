use super::{ MapBuilder, Map, TileType, paint, Position, spawner, SHOW_MAPGEN, Symmetry,
...
impl DrunkardsWalkBuilder {
    ...
    /// Preset settings for a wide open cavern type map
    ...
    /// Preset settings for smaller medium size connected caverns
    ...
    /// Preset settings for narrow interconnected caverns
    ...
    pub fn fat_passages(new_depth : i32) -> DrunkardsWalkBuilder {
        DrunkardsWalkBuilder { map: Map::new(new_depth),
            starting_position: Position{ x : 0, y : 0 }, 
            depth: new_depth, 
            history: Vec::new(), 
            noise_areas: HashMap::new(), 
    ...
    fn build(&mut self) {
        ...
        while floor_tile_count  < desired_floor_tiles {
            ...
            match self.settings.spawn_mode {
                ...
                // each drunkard after the first has a random starting point
        ...
        rltk::console::log(format!("{} dwarves gave up their sobriety, of whom {} actually found a wall.",
