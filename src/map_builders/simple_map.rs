use super::{ apply_room_to_map, apply_horizontal_tunnel, apply_vertical_tunnel, 
             MapBuilder, Map, Position, Rect, SHOW_MAPGEN, spawner, TileType };
...
impl SimpleMapBuilder {
    pub fn new(new_depth : i32) -> SimpleMapBuilder {
        SimpleMapBuilder{ map : Map::new(new_depth),
